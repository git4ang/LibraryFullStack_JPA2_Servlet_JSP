...
<div class="container">
    ...
    <!-- add or update Book -->
    <c:if test="${ empty listBooks && addBook || updateBook }">
    ...
    <c:if test="${ empty listSuppliers && addSupplier || updateSupplier }">
    ...
    <!-- add ordered -->
    <c:if test="${ empty listOrders && addOrdered }">
        <jsp:include page="views/addOrdered.jsp"></jsp:include>
    </c:if>
</div>
</body>
</html>